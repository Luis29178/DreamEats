...
const RewardsLO = ({handleLogIn} : propTypes) => {
  return (
    ...
    <View style={styles.subInfoCard}>
      <Text style={styles.subInfoCardText}>
        {
          "Earn points to redeem available rewards, and stay updated with the latest news and special events."
        }
      </Text>
    </View>
